...
WARNING: This file is automatically generated. Do not edit!
    ...
    <xsl:element name="Window">
      ...
      <title-background>
        <Gradient from="#ff0000ff" to="#88776655" angle="1.047197551196598"/>
      </title-background>
      <background>
    ...
    <TableLayout rows="1" cols="1">
      <cell row="1" col="1">
        <Button name="Ok">
          ...
          <image src="images/gui/dialogs/yesbutton.png" width="100" height="23"/>
          <image-hover src="images/gui/dialogs/yesbutton-hover.png" width="100" height="23"/>
          <image-clicked src="images/gui/dialogs/yesbutton-clicked.png" width="100" height="23"/>
        </Button>
      </cell>
    </TableLayout>
  </xsl:template>
    ...
    <TableLayout rows="1" cols="2">
      <cell row="1" col="1">
        <Button name="No">
          ...
          <image src="images/gui/dialogs/nobutton.png" width="100" height="23"/>
          <image-hover src="images/gui/dialogs/nobutton-hover.png" width="100" height="23"/>
          <image-clicked src="images/gui/dialogs/nobutton-clicked.png" width="100" height="23"/>
        </Button>
      </cell>
      <cell row="1" col="2">
        <Button name="Yes">
